...
echo "<h2> How many tickets for Flight $flightNum would you like to purchase for the customer?<br>";


?>

<form method="post" action="BAbuy.php">
Quantity: <input type="number" name="quan">
Customer Email: <input type="text" name="cemail">
